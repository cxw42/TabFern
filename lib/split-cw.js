...
var Split = function (ids, options) {
    ...
    // Update the gutter on drag.
    var gutterUpdate = options.gutterUpdate || function(){};
    ...
    function adjust (offset) {
        ...
        gutterUpdate.call(this, this.gutter,
                Object.values(elementStyle(dimension, a.size, this.aGutterSize))[0], a.size, b.size);
    }
