...
let TABFERN_VERSION='xx';
function getBoolSetting(){return false;}
let CFG={}
...
var Modules = {};
Modules.hamburger=function(){return {};};
...
//#     let shouldCollapse = getBoolSetting(CFG.COLLAPSE_ON_STARTUP);
//#
...
//#         if(getBoolSetting(CFG.RESTORE_ON_LAST_DELETED, false)) {
...
//#
//#     if(getBoolSetting(CFG.JUMP_WITH_SORT_OPEN_TOP, true)) {
//#         let h = $('html');
...
//#         if(getBoolSetting(CFG.OPEN_TOP_ON_STARTUP)) {
...
//#         getBoolSetting(CFG.ENB_CONTEXT_MENU, true) ? getMainContextMenuItems
//#                                                     : false;
//#
...
function initTree0()
{
    ...
    if(getBoolSetting(CFG.HIDE_HORIZONTAL_SCROLLBARS, false)) {
...
//            );
    ...
    if(api && api.runtime && api.runtime.sendMessage) {
        api.runtime.sendMessage(MSG_GET_VIEW_WIN_ID, function(win_id){console.log({'Got win_id':win_id});});
    } else {
        console.log('no api.runtime.sendMessage');
    }
} //initTree0
