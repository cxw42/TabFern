...
describe('jstree-multitype', ()=>{
    ...
    describe('creation',()=>{
        ...
        it('can be created and load data', (done)=>{
            ...
            treeobj = div.jstree({plugins:['wholerow','multitype'],
                ...
                multitype: {    //known types
                    foo: {li_attr:{'class':'foo',title:'title-foo'}, icon:'icon-foo'},
                    bar: {a_attr:{'class':'bar',title:'title-bar'}, icon:'icon-bar'},
                    baz: {li_attr:{'class':'baz',title:'title-baz'}, icon:'icon-baz'},
                    quux: {li_attr:{'class':'quux',title:'title-quux'}, icon:'icon-quux'},
                    'two-li': {li_attr:{'class':'li1 li2',title:'title-two-li'}},
                    'two-a': {a_attr:{'class':'a1 a2',title:'title-two-a'}, icon:'two-a-icon'},
                    'other-a': {a_attr:{'class':'a3 a4',title:'title-other-a'}},
                    'combo': {  li_attr:{'class':'li-combo',title:'title-combo-li'},
                                a_attr:{'class':'a-combo',title:'title-combo-a'},
                                icon: 'icon-combo'},
                },
            }).jstree(true);
    ...
    describe('deletion',()=>{
        ...
        it("doesn't remove nonexistent multitypes",()=>{
            let child = treeobj.get_node('c2');
            expect(treeobj.del_multitype(child, 'no-such-multitype')).toBeTruthy();
        });
