...
const TABFERN_VERSION='0.2.0-pre.3'  //' alpha \u26a0'
...
const CFGS_OPEN_REST_ON_CLICK = 'open-rest-on-win-click',
        CFG_OROC_DO = "yep",
        CFG_OROC_DO_NOT = "nope";
_DEF[CFGS_OPEN_REST_ON_CLICK] = CFG_OROC_DO_NOT;
_VAL[CFGS_OPEN_REST_ON_CLICK] = (v)=>{
